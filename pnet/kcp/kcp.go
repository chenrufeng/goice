...
func (kcp *KCP) MinSndRmtWnd() uint32 {
	if kcp.rmt_wnd > kcp.snd_wnd {
		return kcp.snd_wnd
	}
	return kcp.rmt_wnd
}

func (kcp *KCP) MinSndRmtWndInt() int {
	if kcp.rmt_wnd > kcp.snd_wnd {
		return int(kcp.snd_wnd)
	}
	return int(kcp.rmt_wnd)
}
